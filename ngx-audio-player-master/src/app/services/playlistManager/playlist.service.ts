...
export class PlaylistService {
  ...
  private playlistUrl = 'https://back-end-mp3.herokuapp.com/api/playlist';
  private playlistUpdate = 'https://back-end-mp3.herokuapp.com/api/playlist/update';
  private addSong1 = 'https://back-end-mp3.herokuapp.com/playlist/addSong';
  private readonly API_URL_CREATE = environment.URL + '/api/playlist/create';
  private playlistByUser = 'https://back-end-mp3.herokuapp.com/api/auth/playListByUser';
